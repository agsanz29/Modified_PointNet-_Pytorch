...
def parse_args():
    ...
    parser.add_argument('--folder', type=str, default='', required=True, help='bones')
...
def main(args):
    ...
    exp_dir = os.path.join(BASE_DIR, 'log')
    folder = args.folder
    
    names_path = os.path.join(BASE_DIR,os.path.join('data', os.path.join(folder,classes_txt)))
